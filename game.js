...
function moveFish(fish) {
  ...
  fish.style.left = `${randomInRange(0, width)}px`;
  fish.style.top = `${randomInRange(0, height)}px`;
}
...
function spawnFish() {
  ...
  const lifetime = MIN_FISH_LIFETIME_MS + randomInRange(0, FISH_LIFETIME_VARIATION_MS);
